...
import static com.mecury.okhttplibrary.internal.http2.Http2.FLAG_NONE;
...
import static com.mecury.okhttplibrary.internal.http2.Http2.illegalArgument;
import static java.util.logging.Level.FINE;


/** Writes HTTP/2 transport frames.写HTTP/2 传输层 */
final class Http2Writer implements Closeable {
  ...
  /** Applies {@code peerSettings} and then sends a settings ACK. 发售那个 ACK */
