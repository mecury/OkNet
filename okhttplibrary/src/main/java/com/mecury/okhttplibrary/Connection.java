...
public interface Connection {
  ...
  /**
   * Returns the TLS handshake(传输层握手) used to establish this connection, or null if the connection is not
   * HTTPS.
   */
  Handshake handshake();

  /**
   * Returns the protocol negotiated(商谈) by this connection, or {@link Protocol#HTTP_1_1} if no protocol
