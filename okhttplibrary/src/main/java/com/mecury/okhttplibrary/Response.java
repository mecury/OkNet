...
public class Response implements Closeable {
     ...
     * will be truncated(截断) to {@code byteCount} bytes.
     *
    ...
    /** Returns true if this response redirects(重定向) to another resource. */
    ...
    /**
     * Returns the response for the HTTP redirect or authorization challenge(授权) that triggered(触发) this
     * response, or null if this response wasn't triggered by an automatic retry. The body of the
     * returned response should not be read because it has already been consumed(消耗) by the redirecting
     * client.
     */
    ...
    /**
     * Returns the cache control directives(缓存指令) for this response. This is never null, even if this
